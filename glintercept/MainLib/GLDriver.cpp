...
GLDriver::~GLDriver()
{
  ...
  ErrorLog * gliLog = &ErrorLog::GetInstance();
...
void GLDriver::ProcessFrameEnd()
{
  ...
  if(loggingEnabled && configData.logMaxFrameLoggingEnabled && frameNumber - loggingStartFrameNum >= configData.logMaxNumLogFrames)
  {
    logStateChange = true;
  }
