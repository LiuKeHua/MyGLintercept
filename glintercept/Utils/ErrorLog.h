...
#define LOGMSG(string) { ErrorLog::GetInstance().LogError string;}  
#define LOGERR(string) { ErrorLog::GetInstance().LogError string;}

#define LOG_MSG(string,...) { ErrorLog::GetInstance().LogError(string,##__VA_ARGS__);}  
#define LOG_ERR(string,...) { ErrorLog::GetInstance().LogError(string,##__VA_ARGS__);}
...
{
public:
	static std::string LOG_DEFAULT_NAME;
