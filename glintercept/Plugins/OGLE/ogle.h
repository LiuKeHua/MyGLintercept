...
public:
	...
	{
		public:	
			Element() { v = 0; t = 0; n = 0; c = 0; }

			Element(VertexPtr _v, VertexPtr _t = 0, VertexPtr _n = 0,VertexPtr _c = 0)
			{
				v = _v; t = _t; n = _n; c = _c;
			}
	...
	void glColorfv(GLfloat *V, GLsizei n);
    ...
    VertexPtr currTexCoord, currNormal,currColor;
